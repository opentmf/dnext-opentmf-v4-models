# dnext-opentmf-663-v4-model

This artifact holds the Dnext extended model classes for the TMF-663 Shopping Cart Management .
...
```
#### Add dnext-opentmf-663-v4-model Module
```xml
<dependency>
  <groupId>org.opentmf.dnext</groupId>
  <artifactId>dnext-opentmf-663-v4-model</artifactId>
</dependency>
```
...
public class JacksonConfig {
  ...
  public ObjectMapper objectMapper() {
    ...
    DnextTmf663JacksonConfig.registerExtensions(objectMapper);
    return objectMapper;
  }
}
```
