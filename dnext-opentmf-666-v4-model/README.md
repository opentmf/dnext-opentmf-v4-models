...
This artifact holds the Dnext extended model classes for the TMF-666 Account Cart Management .
...
```
#### Add dnext-opentmf-666-v4-model Module
```xml
<dependency>
  <groupId>org.opentmf.dnext</groupId>
  <artifactId>dnext-opentmf-666-v4-model</artifactId>
</dependency>
```
...
public class JacksonConfig {
  ...
  public ObjectMapper objectMapper() {
    ...
    DnextTmf666JacksonConfig.registerExtensions(objectMapper);
    return objectMapper;
  }
}
```
